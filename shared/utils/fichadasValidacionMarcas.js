...
} from "./mascaraTokensReloj.js";

export { ZONA_HORARIA_INSTITUCIONAL };
export { MASCARA_RELOJ_DEFAULT, normalizarMascaraTokens, esMascaraParserV1, extraerCamposSegunMascara };

export const DEFAULT_UMBRAL_DUPLICADO_MINUTOS = 2;
export const CODIGO_AVISO_MARCA_DUPLICADA_PROBABLE = "MARCA_DUPLICADA_PROBABLE";
export const CODIGO_ERROR_LINEA_INVALIDA = "LINEA_INVALIDA";
 ...
 */
export function parseFechaTokenReloj(fechaToken) {
 ...
 * @param {string} horaHm
 */
export function parseHoraHmReloj(horaHm) {
 ...
 */
export function instanteMarcaInstitucionalMs(fecha_ymd, hora_hm) {
 ...
 */
export function parseLineaRelojBiometrico(linea, opts = {}) {
 ...
 * @param {string} [opts.mascara_tokens]
 */
export function parseTxtRelojBiometrico(contenidoTxt, opts = {}) {
 ...
 */
export function claveAgenteDiaMarca(marca) {
  const agente =
 ...
 */
export function marcasSonDuplicadoProbable(a, b, umbralMinutos = DEFAULT_UMBRAL_DUPLICADO_MINUTOS) {
 ...
 */
export function detectarDuplicadosProbablesEnLote(marcasOk, opts = {}) {
 ...
 * @param {object} [opts]
 */
export function advertenciasCercaniaMarca(candidata, existentes, opts = {}) {
  const umbral = opts.umbral_duplicado_minutos ?? DEFAULT_UMBRAL_DUPLICADO_MINUTOS;
  const adv = [];
 ...
 */
export function agruparMarcasPorClaveVis(marcas, obtenerClaveVis) {
  const map = new Map();
 ...
 */
export function periodoYmDesdeFechaYmd(fecha_ymd) {
 ...
 */
export function claveVisImportMarca(marca, ctx = {}) {
