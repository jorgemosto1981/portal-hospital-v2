...
export const SCHEMA_SOL_MED_AVISO = "SOL_MED_AVISO_V1";

/** Estados que ocupan días en el calendario del titular (bloquean otro aviso/licencia). */
export const ESTADOS_SOLICITUD_OCUPAN_DIA_AVISO_MED = new Set([
  "cfg_esa_borrador",
 ...
 * @param {string} h2
 */
export function rangosYmdSeSolapan(d1, h1, d2, h2) {
 ...
 */
export function resolverRangoYmdSolicitudArticulo(s) {
 ...
 */
export function estadoSolicitudOcupaDiasParaAvisoMed(estadoId) {
 ...
 */
export function buscarConflictoSolapamientoSolicitudes(desde, hasta, solicitudes, excludeSolId = "") {
