...
export const MODO_RESOLUCION_JEFE_AUTORIZACION = "autorizacion";
export const MODO_RESOLUCION_JEFE_TOMA_CONOCIMIENTO = "toma_conocimiento";
export const MODO_RESOLUCION_JEFE_NINGUNO = "ninguno";

/** @type {readonly string[]} */
export const MODOS_RESOLUCION_JEFE = Object.freeze([
 ...
 */
export function normalizeModoResolucionJefe(raw) {
 ...
 */
export function modoResolucionJefeDesdeVersion(versionData) {
  const wf =
 ...
 */
export function modoResolucionJefeDesdeSolicitud(sol, codigoGrilla) {
