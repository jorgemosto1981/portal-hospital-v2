 ...
 */
export function formatYmdEnZona(ms, timeZone = ZONA_HORARIA_INSTITUCIONAL) {
 ...
 */
export function ymdEnZonaDesdeInstante(ms, timeZone = ZONA_HORARIA_INSTITUCIONAL) {
 ...
 * @param {string} [timeZone]
 */
export function civilDateInZonaToUtcAnchorMs(year, month, day, timeZone = ZONA_HORARIA_INSTITUCIONAL) {
 ...
 * @param {number} [nowMs]
 */
export function obtenerYmdHoyInstitucional(nowMs = Date.now()) {
