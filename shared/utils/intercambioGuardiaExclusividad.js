 ...
 * @returns {string[]}
 */
export function segmentoIdsEjecutablesTitular(segmentos, personaId) {
 ...
 */
export function validarSolapeHorarioTramosPostSwap(idsPost, segmentosCapa = []) {
 ...
 * }} params
 */
export function validarExclusividadTramosIntercambio({
  idsEjecutables,
  segmentosCedidos,
  segmentosRecibidos,
  segmentosCapa = [],
