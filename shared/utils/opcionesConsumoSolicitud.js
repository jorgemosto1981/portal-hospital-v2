 ...
 */
export function leerOpcionesConsumoDesdeVersion(versionData) {
 ...
 */
export function filtrarOpcionesActivas(opciones) {
 ...
 * @param {Record<string, unknown> | null | undefined} versionData
 */
export function versionTieneOpcionesConsumoActivas(versionData) {
 ...
 */
export function resolverOpcionConsumo(versionData, opcionConsumoId) {
 ...
 */
export function reglaComputoDiasIdDesdeOpcion(opcion, versionData) {
 ...
 * @param {OpcionConsumoSolicitudRow} opcion
 */
export function versionDataConOpcionAplicada(versionData, opcion) {
 ...
 * @param {Record<string, unknown> | null | undefined} versionData
 */
export function mapOpcionesParaListadoCliente(versionData) {
