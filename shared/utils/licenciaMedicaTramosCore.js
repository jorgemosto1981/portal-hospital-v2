...
export const CFG_MLM_CORTA_ANUAL = "cfg_mlm_corta_anual";
export const CFG_MLM_LARGA_EPISODIO = "cfg_mlm_larga_episodio";

export const ESTADO_SOLICITUD_APROBADA = "cfg_esa_aprobada";
 ...
 * @returns {string | null}
 */
export function leerModoLicenciaMedicaDesdeVersion(versionData) {
  const ident =
 ...
 * @param {unknown} versionData
 */
export function esLicenciaMedicaCortaAnual(versionData) {
 ...
 * }} input
 */
export function buildLicenciaMedicaPreviewCorta(input) {
...
export { LIMITE_TRAMO_100, LIMITE_TRAMO_60, CUPO_TRAMO_60 };
