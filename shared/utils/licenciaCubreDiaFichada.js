 ...
 */
import { celdaEsperaFichada } from "./grillaFichadaPresencia.js";
 ...
 */
export function listarEventosLicenciaCelda(eventos, celda) {
...
/** @param {Record<string, unknown>} ev */
export function eventoLicenciaAprobadoParaFichada(ev) {
 ...
 * @param {unknown} [eventos]
 */
export function licenciaCubreDiaFichada(celda, eventos) {
 ...
 * @param {Record<string, unknown>|null|undefined} celda
 */
export function celdaSinExpectativaFichada(celda) {
