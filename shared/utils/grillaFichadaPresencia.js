 ...
 */
export function parseFichadasRealesCelda(celda) {
 ...
 */
export function contarMarcasFichadaReal(fichadas) {
 ...
 * @param {Record<string, unknown>|null|undefined} celda
 */
export function celdaTieneCapaFichadaCargada(celda) {
  if (!celda || typeof celda !== "object") return false;
 ...
 * @param {Record<string, unknown>|null|undefined} celda
 */
export function celdaEsperaFichada(celda) {
  if (!celda || typeof celda !== "object") return false;
 ...
 */
export function resolverFichadaPresencia(celda) {
 ...
 * @returns {string[]}
 */
export function lineasHorarioFichadaReal(fichadas) {
 ...
 * @returns {string}
 */
export function textoHorarioFichadaReal(fichadas) {
  if (!Array.isArray(fichadas) || fichadas.length === 0) return "";
 ...
 * @returns {string}
 */
export function textoHorarioFichadaRealDesdeCelda(celda) {
 ...
 */
export function evaluarContradiccionFichadaTeoria(celda) {
