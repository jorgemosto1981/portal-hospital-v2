 ...
 */
export function enriquecerIncumplimientoCeldaPorSegmento(
  segmentos,
...
export function labelBadgeDisciplinaMinutosCelda(minutos) {
 ...
 */
export function incumplimientosDisciplinaDesdeSegmento(seg) {
 ...
 */
export function badgesDisciplinaDesdeSegmentoAnalitica(seg, opts = {}) {
...
/** @param {Record<string, unknown>|null|undefined} seg */
export function segmentoTieneIncumplimientoDisciplina(seg) {
  const inc = incumplimientosDisciplinaDesdeSegmento(seg);
 ...
 * @param {number} [tolerancia_egreso_min]
 */
export function disciplinaHorariaEsIncumplimientoPorMargen(
  tardanza_minutos,
  salida_anticipada_minutos,
  tolerancia_ingreso_min,
  tolerancia_egreso_min,
