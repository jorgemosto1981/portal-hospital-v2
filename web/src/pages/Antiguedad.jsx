    ...
    <div className="min-h-full px-4 py-6 md:px-6 md:py-8 lg:px-8 print:max-w-none print:px-4 print:py-3">
      <div className="mx-auto w-full max-w-6xl space-y-4 print:max-w-none">
        ...
        <AntiguedadCalculoFormCard
          ...
          personaOptionsFiltradas={personaOptionsFiltradas}
          usaFechaEspecifica={usaFechaEspecifica}
          setUsaFechaEspecifica={setUsaFechaEspecifica}
          fechaCorte={fechaCorte}
          setFechaCorte={setFechaCorte}
          fechaCorteEfectivaIso={fechaCorteEfectiva}
          resultado={resultado}
          personaId={personaId}
          busyCalculo={busyCalculo}
          onCalcular={calcular}
        />
        ...
        <AntiguedadExternaCard
          ...
          setDExt={setDExt}
          normativa={normativa}
          setNormativa={setNormativa}
          desde={desde}
          setDesde={setDesde}
          personaId={personaId}
          reconocimientosGuardados={reconocimientosGuardados}
          personaActivaDescripcionReconocimientos={personaActivaDescripcionReconocimientos}
          personaActivaId={personaActivaId}
          busyGuardarExterna={busyGuardarExterna}
          busyEliminarExterna={busyEliminarExterna}
