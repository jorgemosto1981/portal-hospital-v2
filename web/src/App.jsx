...
import ArticulosCfgLista from "./pages/ArticulosCfgLista.jsx";
        ...
        <Route element={<AuthedGateLayout />}>
          ...
          <Route path="/portal" element={<PortalLayout />}>
            ...
            <Route element={<RoleGuard />}>
              ...
              <Route path="rrhh/configuracion-articulos" element={<ArticulosCfgLista />} />
              <Route path="rrhh/configuracion-articulos/nuevo" element={<ArticuloFormConfig />} />
              <Route path="rrhh/configuracion-articulos/:articuloId" element={<ArticuloFormConfig />} />
