export const PANTALLAS_CATALOGO = [
  { id: "inicio", titulo: "Inicio", path: "/inicio", estado: "activo", fuente: "web/src/features/home/PortalHome.jsx" },
  { id: "laboral", titulo: "Datos laborales", path: "/laboral", estado: "mvp", fuente: "web/src/pages/DatosLaborales.jsx" },
  { id: "configuracion", titulo: "Configuración", path: "/configuracion", estado: "activo", fuente: "web/src/pages/Configuracion.jsx" },
  { id: "datos-personales", titulo: "Datos personales", path: "/perfil", estado: "mvp", fuente: "web/src/pages/DatosPersonales.jsx" },
  { id: "perfil-legajo", titulo: "Perfil (legajo por id)", path: "/perfil/per_demo", estado: "mvp", fuente: "web/src/pages/Perfil.jsx" },
