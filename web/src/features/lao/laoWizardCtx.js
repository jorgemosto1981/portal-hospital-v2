 ...
 */
export function buildLaoWizardCtxFromResumen(resumen) {
...
/** @typedef {{ version_aplicada_id: string, anio_origen_bolsa_activo: number, correspondencia_anio: number, ejercicio_label: string | null, version_computo: { bloque_topes_plazos_computo?: Record<string, unknown> } }} LaoWizardCtx */
