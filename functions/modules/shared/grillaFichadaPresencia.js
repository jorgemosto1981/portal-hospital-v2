 ...
 * @returns {string[]}
 */
function marcasHhmmDesdeItemFichada(item) {
 ...
 * @returns {string[]}
 */
function todasMarcasHhmmDesdeCelda(celda) {
  const marcas = [];
