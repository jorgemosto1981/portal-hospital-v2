 ...
 */
function codigoFamilia64SinModalidad(codigo) {
 ...
 */
function nombreFamilia64SinModalidad(nombre) {
  return limpiar(String(nombre || "").replace(RX_MODALIDAD_NOMBRE, ""));
}

module.exports = { codigoFamilia64SinModalidad, nombreFamilia64SinModalidad };
