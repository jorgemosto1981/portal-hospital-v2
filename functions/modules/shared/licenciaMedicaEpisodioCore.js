...
const TOPE_EPISODIO_DIAS_CONTINUOS = 730;
 ...
 */
function calcularConsumoPrevioEpisodioContinuo(periodosAprobados, fechaDesdeNueva) {
 ...
 */
function esLicenciaMedicaLargaEpisodio(versionData) {
 ...
 */
function tieneDictamenFavorableLarga(licenciaMedica, extra) {
 ...
 */
function proyectarEpisodioContinuo(params) {
 ...
 * }} input
 */
function buildLicenciaMedicaPreviewLarga(input) {
...
module.exports = { TOPE_EPISODIO_DIAS_CONTINUOS, FASE_MOTOR_S_MED_LARGA, ymdAddDays, calcularConsumoPrevioEpisodioContinuo, esLicenciaMedicaLargaEpisodio, tieneDictamenFavorableLarga, proyectarEpisodioContinuo, buildLicenciaMedicaPreviewLarga };
