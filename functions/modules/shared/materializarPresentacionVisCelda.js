 ...
 */
function esDiaSinTurnoLaboralDesdeCapa(capaTeorica) {
 ...
 * @param {Record<string, unknown>|null|undefined} capaTeorica
 */
function debeOmitirPresentacionCompuestoMaterializada(capaTeorica) {
 ...
 * @param {Record<string, unknown>|null|undefined} capaTeorica
 */
function pickRdaTurnoIdDesdeCapaMaterializada(capaTeorica) {
 ...
 */
function construirCeldaCtxTrasCapaMaterializada(celdaRaw, capaEnriquecida) {
 ...
 */
function resolverPresentacionVisMaterializada(celdaVis, capaTeorica, analitica, opts = {}) {
...
module.exports = { esDiaSinTurnoLaboralDesdeCapa, debeOmitirPresentacionCompuestoMaterializada, pickRdaTurnoIdDesdeCapaMaterializada, construirCeldaCtxTrasCapaMaterializada, resolverPresentacionVisMaterializada };
