...
const CODIGO_CRUCE_ANIO = "CRUCE_ANIO_CALENDARIO";
const CODIGO_HORIZONTE_TEMPORAL = "HORIZONTE_TEMPORAL";
const CODIGO_INCONSISTENCIA_DIAS_HABILES = "INCONSISTENCIA_DIAS_HABILES";
const CODIGO_INCONSISTENCIA_DIAS_CORRIDOS = "INCONSISTENCIA_DIAS_CORRIDOS";
const CODIGO_FECHA_RANGO_INVALIDO = "FECHA_RANGO_INVALIDO";
 ...
 */
function ymdFinHorizonteAgenteBase(refYmd) {
 ...
 */
function validarCruceAnioCalendario(fechaDesde, fechaHasta) {
 ...
 */
function validarHorizonteTemporalAgente(fechaDesde, refYmd, opts = {}) {
 ...
 * }} input
 */
function validarFechasArticulo(input) {
...
module.exports = { readModoCalculo, syncUsaCalendarioInstitucionalEnTopes, CODIGO_CRUCE_ANIO, CODIGO_HORIZONTE_TEMPORAL, CODIGO_INCONSISTENCIA_DIAS_HABILES, CODIGO_INCONSISTENCIA_DIAS_CORRIDOS, CODIGO_FECHA_RANGO_INVALIDO, mensajeValidacionFechas, readUsaCalendarioInstitucional, ymdFinHorizonteAgenteBase, validarCruceAnioCalendario, validarHorizonteTemporalAgente, validarFechasArticulo };
