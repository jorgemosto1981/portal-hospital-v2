 ...
 */
function restarMesesYmd(ymd, meses) {
 ...
 * }} opts
 */
function sumarDiasInjustificadosVentana(sols, opts) {
 ...
 * @param {number} umbral
 */
function umbralInjustificadasExcedido(diasAcumulados, umbral) {
...
module.exports = { restarMesesYmd, sumarDiasInjustificadosVentana, umbralInjustificadasExcedido };
