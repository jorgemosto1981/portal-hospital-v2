...
const CFG_ETAPA1_COLLECTION = "cfg_etapa1";
const CFG_ETAPA1_RUNTIME_DOC = "runtime";

/** Arts Etapa 1 conocidos (CAMBIO-DIA se agrega al seed cuando exista art_*) */
const ARTICULO_64A_ETAPA1_ID = "art_01KRNK10V10CH7W5M2W6V558GS";
const ARTICULO_64B_ETAPA1_ID = "art_01KRYEX0JZY4Y8J1GY3Q9F8BJQ";
const ARTICULO_63J_ETAPA1_ID = "art_01KVWVW9Z50VR6T1BC6J0R3YQ8";
const ARTICULO_LAO_ID = "art_01KRNYDN5WR7RER7MWXRZ817E7";

/** Defaults si falta el doc (fail-safe: superficies cerradas, piloto off) */
const ETAPA1_RUNTIME_DEFAULTS = Object.freeze({
 ...
 */
function normalizeEtapa1Runtime(raw) {
 ...
 */
function personaEnBypassOpsEtapa1(cfg, personaId, opts = {}) {
 ...
 * @param {ReturnType<typeof normalizeEtapa1Runtime>} cfg
 */
function debeFiltrarCatalogoEtapa1(cfg) {
 ...
 */
function articuloPermitidoEtapa1(cfg, articuloId) {
 ...
 */
function articuloFilaPermitidaEtapa1(cfg, articuloRow) {
