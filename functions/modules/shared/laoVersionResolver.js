 ...
 * @returns {number | null}
 */
function getCorrespondenciaAnioFromVersion(versionData) {
 ...
 */
function versionMatchesAnioOrigen(versionData, anioOrigen) {
 ...
 */
function pickPublishedVersionByCorrespondenciaAnio(versionEntries, correspondenciaAnio) {
 ...
 */
function assertCheckinAnioAllowed(anioOrigen, anioA) {
 ...
 */
function assertVersionInvariantForBolsa(versionData, anioOrigenBolsa) {
...
module.exports = { CFG_EST_VER_PUBLICADA, CHECKIN_COPY_ANIO_A, getCorrespondenciaAnioFromVersion, versionMatchesAnioOrigen, pickPublishedVersionByCorrespondenciaAnio, assertCheckinAnioAllowed, assertVersionInvariantForBolsa };
