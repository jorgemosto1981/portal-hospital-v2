...
function obtenerFechaCortePorDefectoHoy() {
  return obtenerYmdHoyInstitucional();
}

function obtenerFechaCorteLao(anioEnCurso) {
...
module.exports = { ZONA_HORARIA_INSTITUCIONAL, normalizarAcarreoAmd, calcularAntiguedad, obtenerFechaCortePorDefectoHoy, obtenerFechaCorteLao };
