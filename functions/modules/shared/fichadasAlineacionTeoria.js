 ...
 */
function celdaTeoriaCruzaMedianoche(celda) {
 ...
 */
function construirAnclasTeoricasCelda(celda, fechaYmd) {
 ...
 */
function normalizarMarcaCruda(marca) {
 ...
 */
function resolverImputacionNocturnaMarca(marca, ctx) {
 ...
 */
function alinearMarcasConTeoriaDia(params) {
 ...
 */
function alinearMarcasConTeoriaEnCalendario(params) {
