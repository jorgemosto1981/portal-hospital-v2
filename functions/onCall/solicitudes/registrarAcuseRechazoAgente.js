...
const { registrarAcuseRechazoAgente } = require("../../modules/shared/solicitudAcuseRechazoAgenteCore");

const registrarAcuseRechazoAgenteCallable = onCall(async (request) => {
  if (!request.auth) {
  ...
  const result = await registrarAcuseRechazoAgente(db, solicitudId, titularPersonaId);
...
module.exports = { registrarAcuseRechazoAgente: registrarAcuseRechazoAgenteCallable };
