...
| 2026-07-02 | (rama `feat/1919-p4-licencias-largas`, `c165fe2`) | **P4.4 cierre dev:** Art. 16/19 `S_MED_LARGA`, CIE-10/causal, bandeja+MDC+grilla LM-L, smoke `med-clasificar-junta-larga.mjs`; acta [`ACTA_RRHH_EPICA_1919_P4_4_LARGAS_V2.md`](./ACTA_RRHH_EPICA_1919_P4_4_LARGAS_V2.md) |
| 2026-07-02 | **`92cb14e`** (rama `feat/1919-p4-visor-auditor`) | **Bandeja auditor P0+P2+P3:** visor PDF, `previsualizarClasificacionMedicaAuditor`, `listarArticulosLicenciaMedicaAuditor`, selector imputación artículo; deploy piloto hosting + callables |
| 2026-07-02 | **PAUSA bandeja auditor** | Handoff [`HANDOFF_SESION_2026-07-02_PAUSA_BANDEJA_AUDITOR_P4_V2.md`](./HANDOFF_SESION_2026-07-02_PAUSA_BANDEJA_AUDITOR_P4_V2.md) — implementación detenida; UAT §6.1/§6.4 |
...
| 2026-07-03 | **PAUSA C2 CIE-10** | Rama `feat/1919-c2-cie10-clasificacion` — UI + `listarCie10BandejaAuditor` + payload `cie10`; deploy callables OK; UAT visual pendiente — [`HANDOFF_SESION_2026-07-03_PAUSA_C2_CIE10_CLASIFICACION.md`](./HANDOFF_SESION_2026-07-03_PAUSA_C2_CIE10_CLASIFICACION.md) |
