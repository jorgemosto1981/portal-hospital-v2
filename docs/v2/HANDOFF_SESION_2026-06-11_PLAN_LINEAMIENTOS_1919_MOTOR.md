...
### Actualización jun-2026 (continuidad épica)


| Hecho                                       | Documento                                              |
| ------------------------------------------- | ------------------------------------------------------ |
| Plan consolidado P0–P6, gates, checklist    | `PLAN_LINEAMIENTOS_*`                                  |
| Fichas oleada **63.c–k** + transversal RRHH | `LINEAMIENTOS_*`                                       |
| Guía día vs tramo                           | `GUIA_POLITICA_DIA_VS_TRAMO_*`                         |
| ABM §5.1 / LAO §5.2                         | `MODULO_CONFIGURACION_ARTICULOS_V2.md`                 |
| Extensiones configurador (duelo, vigencias) | `RFC_CONFIGURADOR_ARTICULOS_1919_EXTENSIONES_P0_V2.md` |
| Acta Bloque E (firma pendiente)             | `ACTA_RRHH_EPICA_1919_BLOQUE_E_V2.md`                  |
| Tags / hitos                                | `CHANGELOG_1919.md`                                    |


**Pendiente P0:** firma acta + tag `1919-p0-doc-g1`. **P1:** deshardcode ticketera. Ver plan §5–§9.
