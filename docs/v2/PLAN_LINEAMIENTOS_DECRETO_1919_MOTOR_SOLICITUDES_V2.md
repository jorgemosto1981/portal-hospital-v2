...
**`docs/v2/LINEAMIENTOS_DECRETO_1919_89_POR_ARTICULO_V2.md`** (nuevo), con convención fija por fila normativa:
...
- **Art. 63:** justificaciones — un `art_*` por inciso frecuente (plantilla configurador).
...
5. `descripcion_ui` en catálogos `cfg_*`.
