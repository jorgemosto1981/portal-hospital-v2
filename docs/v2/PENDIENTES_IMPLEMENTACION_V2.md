...
| **US-17** | P0 (ops) | Inventario global planes `HABILITADO` sin huecos | [`PLAN_VUELO_US17_INVENTARIO_PLANES.md`](./PLAN_VUELO_US17_INVENTARIO_PLANES.md) · lib + `audit:us17-planes-huecos` ✅ · **falta ejecución prod + reporte** |
