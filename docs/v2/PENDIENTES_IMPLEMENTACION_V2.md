...
**Última actualización:** 2026-06-11 (**T-05** foco URL + paleta + consola jefe ✅ en **`master`** · **US-13** ✅ ops)  
**Rama / release:** **`master`** @ `c27e6d7` · tags **`v2.6.3-gso-us6`** · **`v2.6.3-pos-t05-grilla`** (`8285283`)  
