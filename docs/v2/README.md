...
| [`HANDOFF_SESION_2026-05-13.md`](./HANDOFF_SESION_2026-05-13.md) | **Última sesión:** Refactorización UX/UI "RRHH-First" del Configurador de Artículos — 3 pestañas humanas, widgets extraídos, labels/ayuda contextual, banner Reactivar, campos cupo/frecuencia/evento, definición operativa workflow/burbujeo, corrección `ambito_consumo_id` |
