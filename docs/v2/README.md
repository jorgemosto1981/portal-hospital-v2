...
| **[`HANDOFF_SESION_2026-05-29_TURNO_MENSUAL_PR3_PAUSA.md`](./HANDOFF_SESION_2026-05-29_TURNO_MENSUAL_PR3_PAUSA.md)** | **RETOMAR AQUÍ** — pausa post PR3 (VER + impresión); rama `feat/epic-turno-mensual-fase2-pr3` |
| **[`ANALISIS_INTEGRAL_HLG_TURNOS_MATERIALIZACION_GSO.md`](./ANALISIS_INTEGRAL_HLG_TURNOS_MATERIALIZACION_GSO.md)** | Mapa E2E: HLG → plt → materialización → GSO |
| [`plan cursos analisis hlg Grilla plan.md`](./plan%20cursos%20analisis%20hlg%20Grilla%20plan.md) | Índice Cursor (alias del análisis integral) |
| [`HANDOFF_SESION_2026-05-28_TURNOS_GRILLA_APROBADA.md`](./HANDOFF_SESION_2026-05-28_TURNOS_GRILLA_APROBADA.md) | Histórico 28/05 — matriz asi/vis vs plan; scripts audit |
| [`PENDIENTES_PROXIMA_SESION.md`](./PENDIENTES_PROXIMA_SESION.md) | Índice corto → handoff 29/05 |
