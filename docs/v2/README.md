...
| [`HANDOFF_SESION_2026-05-12.md`](./HANDOFF_SESION_2026-05-12.md) | **Última sesión:** Artículos V2 **triple-layer** — ayuda UI + selects catálogo, persistencia **NULL explícito**, auditoría/limpieza BD catálogos, **deploy reglas** `cfg_articulos`/`versiones`, claims RRHH, guardado atómico validado |
