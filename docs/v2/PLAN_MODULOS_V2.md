...
|--------|---------------------|-------------------------|
| **Ticket / Solicitudes** | Estados del aviso, validaciones, asignación, cierre, ítems por grupo, SLA | **Plan operativo V2:** [`PLAN_TICKETERA_V2.md`](./PLAN_TICKETERA_V2.md) (Fase 1 64-A/64-B cerrada; Fase 2 ticketera dinámica). Además: [`PLAN_DESARROLLO_VERSION2.md`](../../PLAN_DESARROLLO_VERSION2.md), [`UNIFICACION_OTRA_PC_Y_TICKET.md`](./UNIFICACION_OTRA_PC_Y_TICKET.md), [`REVISION_ALINEACION_PLAN_V2.md`](./REVISION_ALINEACION_PLAN_V2.md) |
